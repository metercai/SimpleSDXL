...
def switch_layout_template(presetdata: dict | str, state_params, preset_url=''):
    ...
    engine_class_display = template_engine if template_engine in ['Flux', 'Kolors', 'Wan'] else 'SD15' if template_engine=='Comfy' and task_method=='sd15_aio' else 'Illustrious' if template_engine=='Comfy' and task_method=='il_v_pre_aio' else 'SDXL'
